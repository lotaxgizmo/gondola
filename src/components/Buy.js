...
function Buy() {
    return (
        <div className='relative  linkbg bg-[#C3FCF1] rounded-[55px] p-5 my-10 border-4 border-black overflow-clip m-4'>
                ...
                <div className="left">
                    <div className="elite p-3 top flex flex-row flex-wrap justify-center items-center">
                        ...
                        <a href="/#" target="_blank" rel="noopener noreferrer">
                            <img src={cowswap} alt="" className='w-40 lg:w-60 p-1' />
                        </a>

                        <a href="/#" target="_blank" rel="noopener noreferrer">
                            <img src={uniswap} alt="" className='w-40 lg:w-60 p-1' />
                        </a>

                        <a href="/#" target="_blank" rel="noopener noreferrer">
                            <img src={comingsoon} alt="" className='w-40 lg:w-60 p-1' />
                        </a>
                        <a href="/#" target="_blank" rel="noopener noreferrer">
                            <img src={comingsoon} alt="" className='w-40 lg:w-60 p-1' />
                        </a>
